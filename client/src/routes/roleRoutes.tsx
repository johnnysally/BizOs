    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'pos', element: wrap(<POS />) },
          {
            path: 'products',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Products />)}</Allow>
            ),
          },
          {
            path: 'products/new',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<ProductForm />)}</Allow>
            ),
          },
          {
          ...
          { path: 'sales/:id', element: wrap(<SaleDetail />) },
          {
            path: 'customers',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Customers />)}</Allow>
            ),
          },
          {
            path: 'inventory',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Inventory />)}</Allow>
            ),
          },
          {
            path: 'suppliers',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Suppliers />)}</Allow>
            ),
          },
          {
            path: 'purchase-orders',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<PurchaseOrders />)}</Allow>
            ),
          },
          {
            path: 'invoices',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Invoices />)}</Allow>
            ),
          },
          {
            path: 'users',
          ...
          { path: 'profile', element: wrap(<Profile />) },
          {
            path: 'insights',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Insights />)}</Allow>
            ),
          },
          {
            path: 'chat',
          ...
          },
          {
            path: 'reports',
            element: (
              <Allow roles={['owner', 'manager']}>{wrap(<Reports />)}</Allow>
            ),
          },
